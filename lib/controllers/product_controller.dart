...
class ProductController extends GetxController {
  ...
  IndividualProductsState individualProductsState =
      IndividualProductsState.productsLoading;
  ...
  List<SearchedOffer> searchedOffersList = [];
  ...
  Future<bool> createProductWithOffer(
    ...
    try {
      ...
      var tag = Get.find<TagController>().getTagsByTagName("Buy");
      ...
      final CreateOfferPayload offerPayload = CreateOfferPayload(
          ...
          expiryAt: DateTimeUtils.formatDateWithZone(
    ...
    try {
      ...
      if (response.success == true) {
        ...
        if (response.data != null) {
          searchedOffersList = response.data!;
          searchedProductsList =
              response.data!.map((e) => e.products!.first).toList() ?? [];
        }
  ...
  Future<void> updateProduct(
      String productId, UpdateProductPayload updateProductPayload) async {
    individualProductsState = IndividualProductsState.productsLoading;
    update();
