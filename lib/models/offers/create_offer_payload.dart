...
CreateOfferPayload createOfferPayloadFromJson(String str) =>
    CreateOfferPayload.fromJson(json.decode(str));

String createOfferPayloadToJson(CreateOfferPayload data) =>
