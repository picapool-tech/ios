...
import 'package:picapool/screens/public_chat/chat_info.dart';
import 'package:picapool/screens/public_chat/public_chat_page.dart';
...
class ChatInputField extends StatelessWidget {
  ...
  const ChatInputField({
    ...
    required this.onEmojiIconPressed,
  });
          ...
          if (widget.offer?.name.toLowerCase().contains("- from brands") ??
            ...
            Padding(
              ...
              child: MaterialButton(
                ...
                child: widget.liveOffer != null
                    ? const Text("Book a cab")
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ChatBubble(
                      ...
                      isMe: message.userId == _userController.user!.id,
                      imageUrl: '',
