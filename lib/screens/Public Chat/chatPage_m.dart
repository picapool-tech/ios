                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: isMe ? const Color(0xFFF3D7C5) : const Color(0xFFDEDEDE), // Main bubble colors
                      ...
                      children: [
                        if (replyToMessage != null && replySender != null)
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: isMe ? const Color(0xFFFFE2D0) : const Color(0xFFEBEBEB), // Lighter background for reply
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                const SizedBox(height: 4), // Small space between name and message
                                Text(
                                  replyToMessage!,
                                  style: const TextStyle(
                                    color: Colors.black,
